//! Layer 3 of the cost model: the calibrated pruning decision (the design doc, ADR-018).
//!
...
//! gate uses **Spearman's rank correlation**. (the design doc still shows a Pearson gate; that is the
