//! Layer 2 of the cost model: the empirical runtime predictor (the design doc).
//!
...
/// Per-launch overhead in microseconds (the design doc: ~5 µs). A documented default until
