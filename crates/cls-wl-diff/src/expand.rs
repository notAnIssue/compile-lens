//! Neighborhood expansion for the compile-diff (Tool 2a, design notes Phase 2).
//!
...
/// (design notes): three hops covers a node's local structure without letting one anchor's match
...
/// (design notes). `1.0` when every node is structurally unique; lower with more look-alikes. An
