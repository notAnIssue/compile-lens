...
compile-lens wraps the official tools (it does not rewrite them) and fills those three gaps. It is **not** a replacement for `torch.compile`, a fuzzer, a correctness oracle, or a competing compiler — see [§1.4 of the design doc](./docs/00_design/the design doc#14-not-this) for the explicit non-goals.
...
- [Design doc](./docs/00_design/the design doc) — architecture, design principles, ADR index
