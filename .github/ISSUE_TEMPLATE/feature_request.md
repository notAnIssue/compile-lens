...
<!--
compile-lens has a sharply-defined scope (see design.md §1.4 "Not this"). It is *not*
...
<!-- Pick one or sketch a new tool. design.md §3 lists the existing tools. -->
...
<!-- Briefly check it against design.md §1.4. -->
